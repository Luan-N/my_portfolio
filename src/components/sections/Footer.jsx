...
export const Footer = () => {
  return (
    <footer className="w-full backdrop-blur-lg border-t h-30 border-black/20 dark:border-white/20 py-6 z-10 relative">
      <div className="flex flex-col items-center justify-center gap-4">
        <address className="flex gap-6">
          ...
          <a
            ...
            target="_blank"
            className="flex items-center justify-center w-10 h-10 bg-blue-500 rounded-full hover:bg-blue-500/70 transition-colors"
